const locale = {
  ...
  NewAnnouncement: '<span class="iconfont icon-laba horn"></span>Hey, Happy July Quiz Carnival this week! All logined users can get Rs 10 after first playing 10PM Quiz. Come on!',
  stringWords: [ // 默认串词
