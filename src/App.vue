...
export default {
  ...
  created () {
    ...
    this.$store.dispatch(type._OPEN_DIALOG, {
      ...
      htmlText: `<section style="text-align:left;line-height:1.4;">'Go! Millionaire' live quiz is currently undergoing system maintenance. <p></p>We will back soon, if you have any question, please contact us on Facebook <a id="btn-fb-maintent" href="https://www.facebook.com/APUS-Browser-1532330666785144/ ">APUS Browser</a>! 
\n We hope you continue to support 'Go! Millionaire' live quiz.
<p style="margin: 10px 0 5px;">Thank you!</p>
<p></p>
<p style="margin: 10px 0 10px;">April 4, 2018</p>
</section>`,
      shouldSub: false,
      markType: 0,
      okBtnText: 'OK'
