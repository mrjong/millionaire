<template>
  <div class="policy">
    ...
    <div class="content">
      ...
      <p class="paragraph2">In order to provide better game experience and protect your personal data, please read the following agreement carefully and thank you for your support:</p>
      <div class="service">
        <p class="service__title">Go! Millionaire User Agreement</p>
        <div class="privacy__text" v-html="servicePolicyContent"></div>
        <!-- <iframe class="service__text" src="http://static.subcdn.com/201805211500242f0dfc8e96.html"></iframe> -->
      </div>
      <div class="privacy">
        <p class="privacy__title">Go! Millionaire Privacy Policy</p>
        <div class="privacy__text" v-html="privacyPolicyContent"></div>
...
export default {
  ...
  mounted () {
    api.getPolicyContent('http://privacy.apusapps.com/policy/virtual_apusapps_activity/ALL/en/619/privacy.html').then((data) => {
      this.privacyPolicyContent = data.request.responseText
    })
    api.getPolicyContent('http://privacy.apusapps.com/policy/virtual_apusapps_activity/ALL/en/619/user_privacy.html').then((data) => {
      this.servicePolicyContent = data.request.responseText
    })
  },
  methods: {
    close () {
